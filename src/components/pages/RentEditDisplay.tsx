...
export const RentEditDisplay: React.FC<RentEditDisplayProps> = ({
  ...
  const handleAdd = (e?: React.FormEvent) => {
    ...
    setMessage({
      text: `Rent record for ${date} added successfully to [${activeTable}]!`,
      isError: false,
    });
  ...
  const handleUpdate = (e?: React.FormEvent) => {
    ...
    setMessage({
      text: `Rent record updated successfully in [${activeTable}]!`,
      isError: false,
    });
  ...
  const handleDelete = (e?: React.FormEvent) => {
    ...
    setMessage({
      text: `Rent record deleted and balances recalculated for [${activeTable}]!`,
      isError: false,
    });
